...
import 'package:schoole/models/courses/courses_model.dart';
...
class CoursesCubit extends Cubit<CoursesState> {
  ...
  required int student_id,
    ...
    MockDioHelper.postData(url: 'getMySession',
      data: {
      ...
      mySessionsModel = GetSessionsModel.fromJson(value);
  ...
  required int student_id
    ...
    return MockDioHelper.postData(url: 'getStudentSession',
    data: {
      'student_id':student_id
    },
    token: token)
        .then((value){
      all_courses=GetSessionsModel.fromJson(value);
          print(value);
  ...
  Future Book_Session({
    ...
    return MockDioHelper.postData(url: 'bookSession',
    token: token,
    data: {
      'student_id':student_id,
  ...
  Future UnBook_Session({
    ...
    emit(Loading_Book_Sessions());
    return MockDioHelper.postData(url: 'unBookSession',
        token: token,
        data: {
          'student_id':student_id,
          'session_id':session_id
