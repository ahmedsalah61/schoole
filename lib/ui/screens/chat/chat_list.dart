...
import 'package:schoole/cubit/chat/chat_list/chat_list_states.dart';
import 'package:schoole/ui/widgets/library%20widget.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: default_TextFromField(
                      ...
                      suffix:
                          (chat_list!.isNotEmpty == true &&
                              chat_list[0]['time'] == null)
                          ? IconButton(
                              onPressed: () {
                                cubit.get_Chat_List();
                              },
                  ...
                  ConditionalBuilder(
                    condition: chat_list.isNotEmpty == true,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Lottie.asset('assets/image/chats.json'),
                          ),
                          Text(
                            'There is No contacts... Try to search',
        ...
        child: Row(
          children: [
            Container(
              ...
              //here the image
              child: (chat?['img'] != null)
                  ? Cashed_image(imageUrl: '${chat?['img']}')
