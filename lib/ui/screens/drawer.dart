...
import 'package:schoole/ui/widgets/home_widgets.dart';

Widget DrawerWidget(height, width, context, HomeCubit cubit) {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (isteacher == false) student_data(height, width, cubit),
              if (isparent)
                RowIcon(
              ...
              if (HomeCubit.get(context).isaccountsShow)
                Padding(
                  ...
                  child: ListView.separated(
                      itemBuilder: (context, index) => ItemAccouns(
                          width,
                          cubit,
                          index,
                          cubit
                              .homeModel!.data!.user!.childHomeData![index].name!,
                          cubit
                              .homeModel!.data!.user!.childHomeData![index].id!
                      ),
                      shrinkWrap: true,
                      ...
                      itemCount:
                          cubit.homeModel!.data!.user!.childHomeData!.length),
                ),
              SizedBox(
                height: height * 0.04,
              ),
